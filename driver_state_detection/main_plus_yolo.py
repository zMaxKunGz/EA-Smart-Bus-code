...
def main():
    ...
    if cap.isOpened():
        print("hi")
        window_handle = cv2.namedWindow("CSI Camera2", cv2.WINDOW_AUTOSIZE)
        while cv2.getWindowProperty("CSI Camera2", 0) >= 0:  # infinite loop for webcam video capture
            print("hi2")
        # while True:
            ...
            # # yolo_annotated_frame = results[0].plot()
